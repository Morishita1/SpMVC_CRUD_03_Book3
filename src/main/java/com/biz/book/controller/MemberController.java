...
public class MemberController {
	...
	public String login(@RequestParam String m_userid,@RequestParam String m_password,Model model,
		 ...
		 * 
		 * 	라. 이러한 정볼르 바탕으로 사용자의 req를 처리할 것이가
		 * 		처리하지 않을 것인가를 판단해야한다.
		 * 
		 ...
		 * 	서버로 요청을 보낸다.
		 * 
		 * 6. 그러면 서버는 request정보에 session id가 있는가를 확인하고
		 * 	그 id 정보를 기준으로 하여 login된 정보를 취급하게 된다.
		 * 
		 * 7. spring framework(fava 포함)에서는 HttpSession 클래스를 제공해주고
		 * 	개발자가 session
		 */
